...
_BLOCK_SPECS = [
    ([0.3127, 0.3297, 1.250], (0.9, 0.2, 0.2)),   # 0: target      red
    ([0.1825, 0.3374, 1.250], (0.3, 0.5, 0.9)),   # 1: obstacle_0  blue
    ([0.1712, 0.1608, 1.250], (0.3, 0.9, 0.2)),   # 2: obstacle_1  green
    # ([0.3095, 0.1765, 1.250], (0.9, 0.9, 0.2)),   # 3: obstacle_2  yellow
]

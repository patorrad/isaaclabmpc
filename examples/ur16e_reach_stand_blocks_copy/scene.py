...
_BLOCK_SPECS = [
    ([0.6127,  0.0797, 0.875], (0.9, 0.2, 0.2)),   # 0: target      red
    ([0.4825,  0.0874, 0.875], (0.3, 0.5, 0.9)),   # 1: obstacle_0  blue
    ([0.4712, -0.0893, 0.875], (0.3, 0.9, 0.2)),   # 2: obstacle_1  green
    ([0.6095, -0.0735, 0.875], (0.9, 0.9, 0.2)),   # 3: obstacle_2  yellow
]
...
def make_static_cfgs() -> list:
    ...
    table_cfg = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=(0.65, 0.0, 0.8)),
    )
